    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ".NET" },
                    { 2, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Java" },
                    { 3, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Python" },
                    { 4, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Javascript" },
                    { 5, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "AWS" },
                    { 6, true, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Azure" }
                });
